...
class Pages extends Component {
  ...
  handleEditlecture(item) {
    window.localStorage.setItem("pages", JSON.stringify(item));
    // window.localStorage.setItem('language',item.language_id );
    window.localStorage.setItem(
      "all_pages",
      JSON.stringify(this.state.lectures)
    );
    this.props.history.push("/admin/edit-pages");
  }

  handleAddNewSubject() {
    
    this.props.history.push("/admin/add-pages");
  }
  ...
  trashPage(item) {
    ...
    this.setState({
      response: fetch("http://18.221.183.249:3000/trash_header-content", {
        method: "POST",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
  ...
  restorePage(item) {
     ...
     formBody = formBody.join("&");
     this.setState({
      response: fetch('http://18.221.183.249:3000/restore_header-content', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'Cache-Control': 'max-age=31536000'
...
// {console.log(this.state.selectedLanguage[0].value,'c-c-c')}
...
// else if  (item.language_id !=this.state.selectedLanguage.value)
//     {
//       if (this.state.all_selected == true) {
//         if (item.status != 2) {
//           console.log(this.state.all_selected, item.status);
            ...
            >
             ...
             <React.Fragment>
              ...
              <div className="page_heading">
                ...
                <span
                  onClick={() => this.props.history.push('/admin/add-pages')}
