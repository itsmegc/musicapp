...
export default class examinations extends Component {
  ...
  getExaminations = async () => {
    ...
    this.setState({
      response: fetch("http://18.221.47.207:3000/get_examinations", {
        method: "GET"
      })
  ...
  handleEditTest(item) {
    ...
    this.props.history.push("/admin/edit-examination");
  }

  handleAddNewExam() {
    //   window.localStorage.setItem('test_list',JSON.stringify(this.state.test_data))
    this.props.history.push("/admin/add-examination");
  }
              ...
              <div>
                ...
                >
                  <tr style={{ backgroundColor: "white" }}>
                    ...
                    <th className="">Examination Name</th>
                    <th className="textFontSize">Date added</th>
                    <th>Status</th>
                  </tr>
