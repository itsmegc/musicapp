...
class allTax extends Component {
  constructor( props ) {
      super( props );
...
componentDidMount(){
  ...
  getSubjects=async()=>{
    ...
    this.setState({
        loading:true
          ...
          this.setState({
          response: fetch('https://www.webquickfix.com/get_tax', {
          method: 'GET',
      ...
      renderStatus(item){
        ...
        changeStatus(item,status){
            this.setState({
             ...
             this.setState({
              response: fetch('https://www.webquickfix.com/tax_status', {
                method: 'POST',
                headers: {
  ...
  if(this.state.all_selected==true ){
      ...
      return (     
        ...
        <td >   <span style={{fontFamily:'Ubuntu-B',color:'#0073aa'}}>{item.tax_value}</span> 
        </td>
  ...
  render() {
    ...
    return (
      ...
      <SidebarPage {...this.props}  active={6} />
        ...
        <div className="page_heading"><h3 style={{marginBottom:0,marginRight:'5px'}}>All Tax</h3>
